                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  <tr class="gradeU">
                                      ...
                                      <td>
                                          <strong><a href="<?php echo site_url('admin/course_form/course_edit/'.$course_data['id']); ?>" target="_blank"><?php echo $course_data['title']; ?></a></strong><br>
                                          <small><button type="button" class="btn btn-success btn-icon btn-rounded btn-sm" onclick="">Terima</button></small>
                                          <small><button type="button" class="btn btn-danger btn-icon btn-rounded btn-sm" onclick="">Tolak</button></small>
                                      </td>
                                      ...
                                      <td>
                                          ...
                                          <button type="button" class="btn btn-outline-success btn-icon btn-rounded btn-sm" onclick=""> <i class="dripicons-print"></i> </button>
                                      </td>
                                  </tr>
                              <?php endforeach; ?>
                          </tbody>
