        ...
        <div class="course-header-wrap">
          ...
          <div class="rating-row">
            ...
            <span class="enrolled-num">
              ...
              echo $number_of_enrolments . ' Siswa Terdaftar';
              ?>
            </span>
            ...
            <div class="course-curriculum-title clearfix mt-5 mb-3">
              ...
              <div class="float-end mt-2">
                <span class="total-lectures">
                  <?php echo $this->crud_model->get_lessons('course', $course_details['id'])->num_rows() . ' Pertemuan'; ?>
                </span>
              ...
              foreach ($sections as $key => $section) : ?>
                <div class="lecture-group-wrapper">
                  ...
                  <div class="lecture-group-title clearfix" style="<?= $style; ?>" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?php if ($counter == 0) echo 'true'; ?>">
                    ...
                    <div class="float-end">
                      <span class="total-lectures">
                        <?php echo $this->crud_model->get_lessons('section', $section['id'])->num_rows() . ' Pertemuan'; ?>
                      </span>
                      <!-- <span class="total-time">
        ...
        <div class="course-sidebar natural">
          ...
          <div class="course-sidebar-text-box">
            ...
            <?php if (is_purchased($course_details['id'])) : ?>
              ...
              <!--<div class="already_purchased">-->
              <!--  <a href="<?php echo site_url('home/my_courses'); ?>">Unduh Sertifikat</a>-->
              <!--</div>-->
            <?php else : ?>
              ...
              <?php if ($course_details['is_free_course'] == 1) : ?>
                <div class="buy-btns">
                  <?php if ($this->session->userdata('user_login') != 1) : ?>
                    <a href="javascript:;" class="btn btn-buy-now" onclick="handleEnrolledButton()">Daftar</a>
                  <?php else : ?>
                    <a href="<?php echo site_url('home/get_enrolled_to_free_course/' . $course_details['id']); ?>" class="btn btn-buy-now">Daftar</a>
                  <?php endif; ?>
                </div>
              <?php else : ?>
                <div class="buy-btns">
            ...
            <div class="includes">
              ...
              <ul>
                <?php if ($course_details['course_type'] == 'general') : ?>
                  <li><i class="far fa-file"></i><?php echo $this->crud_model->get_lessons('course', $course_details['id'])->num_rows() . ' Pertemuan'; ?></li>
