        ...
        <div class="row">
            <div class="col position-relative">
                <div class="home-banner-wrap">
                    <h2 class="fw-bold" style="text-transform: uppercase;"><?php echo site_phrase(get_frontend_settings('banner_title')); ?></h2>
                    <p style="text-transform: Capitalize;"><?php echo site_phrase(get_frontend_settings('banner_sub_title')); ?></p>
...
<?php if($course_accessibility): ?>
                                        ...
                                        <div class="course-details">
                                            ...
                                            <div class="d-flex text-dark">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <span class="text-muted text-12px"><?php echo $lessons->num_rows().' Pertemuan'; ?></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="course-popover-content">
                                        ...
                                        <div class="popover-btns">
                                            <?php if (is_purchased($top_course['id'])) : ?>
                                                <div class="purchased">
                                                    <a href="<?php echo site_url('home/my_courses'); ?>">Sudah Terdaftar</a>
                                                </div>
                                            <?php else : ?>
                                                <?php if ($top_course['is_free_course'] == 1) :
                                                    ...
                                                    <a href="<?php echo $url; ?>" class="btn green radius-10" onclick="handleEnrolledButton()">Daftar</a>
                                                <?php else : ?>
    ...
    <section class="course-carousel-area">
        <div class="container-lg">
            <div class="row">
                <div class="col">
                    <h3 class="course-carousel-title mb-4">Pelatihan - Pelatihan Terbaru</h3>
                                    ...
                                    <div class="course-popover-content">
                                        ...
                                        <div class="course-meta">
                                            <?php if ($latest_course['course_type'] == 'general') : ?>
                                                <span class=""><i class="fas fa-play-circle"></i>
                                                    <?php echo $this->crud_model->get_lessons('course', $latest_course['id'])->num_rows() . ' Pertemuan'; ?>
                                                </span>
    ...
    <section class="section-blog py-5">
        <div class="container-lg">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-md-3 g-4 justify-content-center">
                <div class="col-12">
                    <h4 class="fw-700">Berita dan Info Terbaru</h4>
                </div>
                ...
                <div class="col-12">
                    <a class="float-end btn btn-outline-secondary px-3 fw-600" href="<?php echo site_url('blogs'); ?>">Lihat Semua</a>
                </div>
            </div>
        </div>
    </section>
...
<section class="section-blog py-5">
        <div class="container-lg">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-md-3 g-4 justify-content-center">
                <div class="col-12">
                    <h4 class="fw-700">Mitra Kerja</h4>
                </div>
                    <div class="col">
                        <div class="card">
                                <img src="<?= base_url("uploads/img_tambahan/PT CREVIS.jpg"); ?>" width="auto" height="70px" float="left" alt="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                                <img src="<?= base_url("uploads/img_tambahan/PT. Handsome.jpg"); ?>" height="70px" float="left" alt="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                                <img src="<?= base_url("uploads/img_tambahan/PT. Hyun dong Indonesia.JPG"); ?>" height="70px" float="left" alt="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                                <img src="<?= base_url("uploads/img_tambahan/PT. Shinwon Indonesia.jpg"); ?>" height="70px" float="left" alt="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                                <img src="<?= base_url("uploads/img_tambahan/PT. TKG Taekwang.png"); ?>" height="70px" float="left" alt="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                                <img src="<?= base_url("uploads/img_tambahan/PT. Willbes global.jpg"); ?>" height="70px" float="left" alt="">
                        </div>
                    </div>
            </div>
        </div>
...
<!--                                <h2>Mitra Kerja</h2>-->
<!--                                <p>Mitra Kami dalam melayani Anda</p>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                                <div class="top-instructor-img ms-auto me-auto">-->
<!--                                    <a href="#">-->
<!--                                        <img src="<?= base_url("uploads/img_tambahan/PT CREVIS.jpg"); ?>" width="100%" height="auto" float="left" margin-right="20px">-->
<!--                                    </a>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                            <div class="card radius-10">-->
<!--                                <div class="top-instructor-img ms-auto me-auto">-->
<!--                                    <a href="#">-->
<!--                                        <img src="<?= base_url("uploads/img_tambahan/PT CREVIS.jpg"); ?>" width="100%" height="auto" float="left" padding="20px">-->
<!--                                    </a>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                    </div>-->
